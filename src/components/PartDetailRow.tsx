    ...
    >
      ...
      <div class="min-w-0">
        <div class="flex items-center gap-2">
          ...
          <button
            type="button"
            class="rounded-full border border-white/8 bg-white/4 px-2 py-0.5 font-mono text-[10px] uppercase tracking-[0.12em] text-text-tertiary transition-colors hover:text-text-primary"
            onFocus={handleOpen}
